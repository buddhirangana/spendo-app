...
public final class ItemTransactionDetailedBinding implements ViewBinding {
  @NonNull
  ...
  private ItemTransactionDetailedBinding(@NonNull LinearLayout rootView,
  ...
  @NonNull
  public static ItemTransactionDetailedBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemTransactionDetailedBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_transaction_detailed, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemTransactionDetailedBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemTransactionDetailedBinding((LinearLayout) rootView, ivCategoryIcon, tvAmount,
